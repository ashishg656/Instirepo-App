...
public class CustomGoogleFloatingActionButton extends FloatingActionButton {

	private int mSize;

	public CustomGoogleFloatingActionButton(Context context) {
		this(context, null);
	}

	public CustomGoogleFloatingActionButton(Context context, AttributeSet attrs) {
	...
	public CustomGoogleFloatingActionButton(Context context,
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				FloatingActionButton, defStyleAttr,
	...
	private final int getSizeDimension() {
		...
		case 0:
		default:
			return this.getResources().getDimensionPixelSize(
