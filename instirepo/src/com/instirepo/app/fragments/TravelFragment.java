...
public class TravelFragment extends BaseFragment implements OnConnectionFailedListener, ConnectionCallbacks,
	...
	void loadData() {
		if (!isRequestRunning) {
			...
			CustomStringRequest req = new CustomStringRequest(Method.POST, getAllNearbyTravels, "location", this, p);
			ZApplication.getInstance().addToRequestQueue(req, "location");
