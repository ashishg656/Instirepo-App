...
public class NothingSelectedSpinnerAdapter implements SpinnerAdapter,
	...
	public NothingSelectedSpinnerAdapter(SpinnerAdapter spinnerAdapter,
			...
			Context context, String nothingSelectedText) {
	...
	public View getNothingSelectedView(ViewGroup parent) {
		View v = layoutInflater.inflate(nothingSelectedLayout, parent, false);
		((TextView) v.findViewById(R.id.text1)).setText(nothingSelectedText);
		return v;
	}
