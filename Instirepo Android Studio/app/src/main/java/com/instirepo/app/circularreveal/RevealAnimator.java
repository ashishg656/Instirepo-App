package com.instirepo.app.circularreveal;
...
import com.instirepo.app.circularreveal.ViewAnimationUtils.SimpleAnimationListener;
...
public interface RevealAnimator {
	...
	/**
	 * {@link ViewAnimationUtils#createCircularReveal(View, int, int, float, float)}
	 * is called it creates new
	 * {@link io.codetail.animation.RevealAnimator.RevealInfo} and attaches to
	 * parent, here is necessary data about animation
	 * 
	 * @param info
	 *            reveal information
	 * 
	...
	/**
	 * Returns new {@link SupportAnimator} that plays reversed animation of
	 * current one
	 * 
	...
	class RevealInfo {
		...
		public RevealInfo(int centerX, int centerY, float startRadius,
				float endRadius, WeakReference<View> target) {
