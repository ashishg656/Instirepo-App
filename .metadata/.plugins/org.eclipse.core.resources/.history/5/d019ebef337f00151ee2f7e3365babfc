...
import static com.bookncart.app.circularreveal.RevealAnimator.CLIP_RADIUS;
...
import com.bookncart.app.circularreveal.RevealAnimator.RevealInfo;
...
public class ViewAnimationUtils {
	...
	public static SupportAnimator createCircularReveal(View view, int centerX,
		...
		revealLayout.attachRevealInfo(new RevealInfo(centerX, centerY,
				startRadius, endRadius, new WeakReference<>(view)));
